...
| "报纸""复古""号外""旧报纸" | Newspaper 旧报纸风 | `SKILL_newspaper.md` |
...
| "只要 Markdown""公众号文章""纯文字" | Markdown 直出 | `SKILL_markdown.md` |
...
- **子技能**：`SKILL_wuxia_pipeline.md`、`SKILL_newspaper.md`、`SKILL_markdown.md`
...
- **墨小颠配图**：调用 `wuxia-avatar` skill 生成手绘线稿
